...
// * Recommendations for different quadrants
 ...
 * This separates the heavy list rendering from the frequent intensity/valence/arousal updates.
 */
const EmotionWordList = React.memo(({ recommended, colors, emotionWords, selectedEmotionWords, onToggle }) => {
